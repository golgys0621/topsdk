...
type AlibabaAlihealthDrugCodeKytWesQuerycoderelationProduceInfoDto struct {
    ...
    /*
        上市许可持有人ref     */
    AuthorizerRefEntId  *string `json:"authorizer_ref_ent_id,omitempty" `
...
func (s *AlibabaAlihealthDrugCodeKytWesQuerycoderelationProduceInfoDto) SetAuthorizedRefName(v string) *AlibabaAlihealthDrugCodeKytWesQuerycoderelationProduceInfoDto {
    s.AuthorizedRefName = &v
    return s
}
func (s *AlibabaAlihealthDrugCodeKytWesQuerycoderelationProduceInfoDto) SetAuthorizerRefEntId(v string) *AlibabaAlihealthDrugCodeKytWesQuerycoderelationProduceInfoDto {
