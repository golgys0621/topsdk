...
type AlibabaAlihealthDrugMscSaveentAddEntReqDto struct {
    /*
        企业详细注册地址     */
    ...
    /*
        企业其他地址省市区信息     */
    StoreAddrs  *[]AlibabaAlihealthDrugMscSaveentAddress `json:"store_addrs,omitempty" `
    ...
    /*
        企业注册地址省市区信息     */
    RegAddr  *AlibabaAlihealthDrugMscSaveentAddress `json:"reg_addr,omitempty" `
...
func (s *AlibabaAlihealthDrugMscSaveentAddEntReqDto) SetDictRegionDetail(v string) *AlibabaAlihealthDrugMscSaveentAddEntReqDto {
    s.DictRegionDetail = &v
    return s
}
func (s *AlibabaAlihealthDrugMscSaveentAddEntReqDto) SetEntOrgType(v int64) *AlibabaAlihealthDrugMscSaveentAddEntReqDto {
    s.EntOrgType = &v
    return s
}
func (s *AlibabaAlihealthDrugMscSaveentAddEntReqDto) SetStoreAddrs(v []AlibabaAlihealthDrugMscSaveentAddress) *AlibabaAlihealthDrugMscSaveentAddEntReqDto {
    s.StoreAddrs = &v
    return s
}
func (s *AlibabaAlihealthDrugMscSaveentAddEntReqDto) SetEntName(v string) *AlibabaAlihealthDrugMscSaveentAddEntReqDto {
    s.EntName = &v
    return s
}
func (s *AlibabaAlihealthDrugMscSaveentAddEntReqDto) SetUserRoleType(v int64) *AlibabaAlihealthDrugMscSaveentAddEntReqDto {
    s.UserRoleType = &v
    return s
}
func (s *AlibabaAlihealthDrugMscSaveentAddEntReqDto) SetRegAddr(v AlibabaAlihealthDrugMscSaveentAddress) *AlibabaAlihealthDrugMscSaveentAddEntReqDto {
    s.RegAddr = &v
    return s
}
func (s *AlibabaAlihealthDrugMscSaveentAddEntReqDto) SetLicenseType(v int64) *AlibabaAlihealthDrugMscSaveentAddEntReqDto {
    s.LicenseType = &v
    return s
}
func (s *AlibabaAlihealthDrugMscSaveentAddEntReqDto) SetMobilePhone(v string) *AlibabaAlihealthDrugMscSaveentAddEntReqDto {
    s.MobilePhone = &v
    return s
}
func (s *AlibabaAlihealthDrugMscSaveentAddEntReqDto) SetOrgCode(v string) *AlibabaAlihealthDrugMscSaveentAddEntReqDto {
    s.OrgCode = &v
    return s
}
func (s *AlibabaAlihealthDrugMscSaveentAddEntReqDto) SetTel(v string) *AlibabaAlihealthDrugMscSaveentAddEntReqDto {
    s.Tel = &v
    return s
}
func (s *AlibabaAlihealthDrugMscSaveentAddEntReqDto) SetContactPsnNm(v string) *AlibabaAlihealthDrugMscSaveentAddEntReqDto {
    s.ContactPsnNm = &v
    return s
}
func (s *AlibabaAlihealthDrugMscSaveentAddEntReqDto) SetEmail(v string) *AlibabaAlihealthDrugMscSaveentAddEntReqDto {
    s.Email = &v
    return s
}
func (s *AlibabaAlihealthDrugMscSaveentAddEntReqDto) SetPartnerId(v string) *AlibabaAlihealthDrugMscSaveentAddEntReqDto {
    s.PartnerId = &v
    return s
}
