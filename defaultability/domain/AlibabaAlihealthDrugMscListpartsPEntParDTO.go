...
func (s *AlibabaAlihealthDrugMscListpartsPEntParDTO) SetShared(v string) *AlibabaAlihealthDrugMscListpartsPEntParDTO {
    s.Shared = &v
    return s
}
func (s *AlibabaAlihealthDrugMscListpartsPEntParDTO) SetOrgCode(v string) *AlibabaAlihealthDrugMscListpartsPEntParDTO {
    s.OrgCode = &v
    return s
}
