...
type AlibabaAlihealthDrugKytWesSaveentAddEntReqDTO struct {
    /*
        企业详细注册地址     */
    ...
    /*
        企业其他地址省市区信息     */
    StoreAddrs  *[]AlibabaAlihealthDrugKytWesSaveentAddress `json:"store_addrs,omitempty" `
    ...
    /*
        企业注册地址省市区信息     */
    RegAddr  *AlibabaAlihealthDrugKytWesSaveentAddress `json:"reg_addr,omitempty" `
...
func (s *AlibabaAlihealthDrugKytWesSaveentAddEntReqDTO) SetDictRegionDetail(v string) *AlibabaAlihealthDrugKytWesSaveentAddEntReqDTO {
    s.DictRegionDetail = &v
    return s
}
func (s *AlibabaAlihealthDrugKytWesSaveentAddEntReqDTO) SetEntOrgType(v int64) *AlibabaAlihealthDrugKytWesSaveentAddEntReqDTO {
    s.EntOrgType = &v
    return s
}
func (s *AlibabaAlihealthDrugKytWesSaveentAddEntReqDTO) SetStoreAddrs(v []AlibabaAlihealthDrugKytWesSaveentAddress) *AlibabaAlihealthDrugKytWesSaveentAddEntReqDTO {
    s.StoreAddrs = &v
    return s
}
func (s *AlibabaAlihealthDrugKytWesSaveentAddEntReqDTO) SetEntName(v string) *AlibabaAlihealthDrugKytWesSaveentAddEntReqDTO {
    s.EntName = &v
    return s
}
func (s *AlibabaAlihealthDrugKytWesSaveentAddEntReqDTO) SetUserRoleType(v int64) *AlibabaAlihealthDrugKytWesSaveentAddEntReqDTO {
    s.UserRoleType = &v
    return s
}
func (s *AlibabaAlihealthDrugKytWesSaveentAddEntReqDTO) SetRegAddr(v AlibabaAlihealthDrugKytWesSaveentAddress) *AlibabaAlihealthDrugKytWesSaveentAddEntReqDTO {
    s.RegAddr = &v
    return s
}
func (s *AlibabaAlihealthDrugKytWesSaveentAddEntReqDTO) SetLicenseType(v int64) *AlibabaAlihealthDrugKytWesSaveentAddEntReqDTO {
    s.LicenseType = &v
    return s
}
func (s *AlibabaAlihealthDrugKytWesSaveentAddEntReqDTO) SetMobilePhone(v string) *AlibabaAlihealthDrugKytWesSaveentAddEntReqDTO {
    s.MobilePhone = &v
    return s
}
func (s *AlibabaAlihealthDrugKytWesSaveentAddEntReqDTO) SetOrgCode(v string) *AlibabaAlihealthDrugKytWesSaveentAddEntReqDTO {
    s.OrgCode = &v
    return s
}
func (s *AlibabaAlihealthDrugKytWesSaveentAddEntReqDTO) SetTel(v string) *AlibabaAlihealthDrugKytWesSaveentAddEntReqDTO {
    s.Tel = &v
    return s
}
func (s *AlibabaAlihealthDrugKytWesSaveentAddEntReqDTO) SetContactPsnNm(v string) *AlibabaAlihealthDrugKytWesSaveentAddEntReqDTO {
    s.ContactPsnNm = &v
    return s
}
func (s *AlibabaAlihealthDrugKytWesSaveentAddEntReqDTO) SetEmail(v string) *AlibabaAlihealthDrugKytWesSaveentAddEntReqDTO {
    s.Email = &v
    return s
}
func (s *AlibabaAlihealthDrugKytWesSaveentAddEntReqDTO) SetPartnerId(v string) *AlibabaAlihealthDrugKytWesSaveentAddEntReqDTO {
    s.PartnerId = &v
    return s
}
