...
func (s *AlibabaAlihealthDrugKytWesQueryUpbillcodeBillUpstreamDTO) SetCodeStr(v string) *AlibabaAlihealthDrugKytWesQueryUpbillcodeBillUpstreamDTO {
    s.CodeStr = &v
    return s
}
func (s *AlibabaAlihealthDrugKytWesQueryUpbillcodeBillUpstreamDTO) SetBillOutId(v string) *AlibabaAlihealthDrugKytWesQueryUpbillcodeBillUpstreamDTO {
    s.BillOutId = &v
    return s
}
