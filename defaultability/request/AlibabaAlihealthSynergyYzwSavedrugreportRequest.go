...
type AlibabaAlihealthSynergyYzwSavedrugreportRequest struct {
    ...
    /*
        本企业用户ID或者姓名，填写企业内部系统ID就可，主要用于本企业查看资料上传人     */
    UserId  *string `json:"user_id" required:"true" `
    /*
        请务必填写印章名称进行盖章。seal_name盖章名称可以直接在码上放心客户端查询，或者通过alibaba.alihealth.synergy.yzw.listseals查询印章名称。     */
    ...
    /*
        X坐标 ，需要盖章时可以使用position_x和position_y制定印章位置，不填则使用默认位置     */
