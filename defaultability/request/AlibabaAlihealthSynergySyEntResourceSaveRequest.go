...
type AlibabaAlihealthSynergySyEntResourceSaveRequest struct {
    ...
    ResourceData  *[]byte `json:"resource_data,omitempty" required:"false" `
    /*
        文件类型，支持pdf和图片格式     */
...
func (s *AlibabaAlihealthSynergySyEntResourceSaveRequest) SetFileUrl(v string) *AlibabaAlihealthSynergySyEntResourceSaveRequest {
    s.FileUrl = &v
    return s
}
func (s *AlibabaAlihealthSynergySyEntResourceSaveRequest) SetNeedAi(v string) *AlibabaAlihealthSynergySyEntResourceSaveRequest {
    s.NeedAi = &v
    return s
}
