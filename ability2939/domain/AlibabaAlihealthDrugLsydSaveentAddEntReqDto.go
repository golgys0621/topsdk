...
type AlibabaAlihealthDrugLsydSaveentAddEntReqDto struct {
    /*
        企业详细注册地址     */
    ...
    /*
        企业其他地址省市区信息     */
    StoreAddrs  *[]AlibabaAlihealthDrugLsydSaveentAddress `json:"store_addrs,omitempty" `
    ...
    /*
        企业注册地址省市区信息     */
    RegAddr  *AlibabaAlihealthDrugLsydSaveentAddress `json:"reg_addr,omitempty" `
...
func (s *AlibabaAlihealthDrugLsydSaveentAddEntReqDto) SetDictRegionDetail(v string) *AlibabaAlihealthDrugLsydSaveentAddEntReqDto {
    s.DictRegionDetail = &v
    return s
}
func (s *AlibabaAlihealthDrugLsydSaveentAddEntReqDto) SetEntOrgType(v int64) *AlibabaAlihealthDrugLsydSaveentAddEntReqDto {
    s.EntOrgType = &v
    return s
}
func (s *AlibabaAlihealthDrugLsydSaveentAddEntReqDto) SetStoreAddrs(v []AlibabaAlihealthDrugLsydSaveentAddress) *AlibabaAlihealthDrugLsydSaveentAddEntReqDto {
    s.StoreAddrs = &v
    return s
}
func (s *AlibabaAlihealthDrugLsydSaveentAddEntReqDto) SetEntName(v string) *AlibabaAlihealthDrugLsydSaveentAddEntReqDto {
    s.EntName = &v
    return s
}
func (s *AlibabaAlihealthDrugLsydSaveentAddEntReqDto) SetUserRoleType(v int64) *AlibabaAlihealthDrugLsydSaveentAddEntReqDto {
    s.UserRoleType = &v
    return s
}
func (s *AlibabaAlihealthDrugLsydSaveentAddEntReqDto) SetRegAddr(v AlibabaAlihealthDrugLsydSaveentAddress) *AlibabaAlihealthDrugLsydSaveentAddEntReqDto {
    s.RegAddr = &v
    return s
}
func (s *AlibabaAlihealthDrugLsydSaveentAddEntReqDto) SetLicenseType(v int64) *AlibabaAlihealthDrugLsydSaveentAddEntReqDto {
    s.LicenseType = &v
    return s
}
func (s *AlibabaAlihealthDrugLsydSaveentAddEntReqDto) SetMobilePhone(v string) *AlibabaAlihealthDrugLsydSaveentAddEntReqDto {
    s.MobilePhone = &v
    return s
}
func (s *AlibabaAlihealthDrugLsydSaveentAddEntReqDto) SetOrgCode(v string) *AlibabaAlihealthDrugLsydSaveentAddEntReqDto {
    s.OrgCode = &v
    return s
}
func (s *AlibabaAlihealthDrugLsydSaveentAddEntReqDto) SetTel(v string) *AlibabaAlihealthDrugLsydSaveentAddEntReqDto {
    s.Tel = &v
    return s
}
func (s *AlibabaAlihealthDrugLsydSaveentAddEntReqDto) SetContactPsnNm(v string) *AlibabaAlihealthDrugLsydSaveentAddEntReqDto {
    s.ContactPsnNm = &v
    return s
}
func (s *AlibabaAlihealthDrugLsydSaveentAddEntReqDto) SetEmail(v string) *AlibabaAlihealthDrugLsydSaveentAddEntReqDto {
    s.Email = &v
    return s
}
func (s *AlibabaAlihealthDrugLsydSaveentAddEntReqDto) SetPartnerId(v string) *AlibabaAlihealthDrugLsydSaveentAddEntReqDto {
    s.PartnerId = &v
    return s
}
