...
func (s *AlibabaAlihealthDrugtraceTopLsydQueryUpbillcodeBillUpstreamDTO) SetStatusDesc(v string) *AlibabaAlihealthDrugtraceTopLsydQueryUpbillcodeBillUpstreamDTO {
    s.StatusDesc = &v
    return s
}
