...
func (s *AlibabaAlihealthDrugtraceTopLsydQueryListpartsPEntParDto) SetShared(v string) *AlibabaAlihealthDrugtraceTopLsydQueryListpartsPEntParDto {
    s.Shared = &v
    return s
}
func (s *AlibabaAlihealthDrugtraceTopLsydQueryListpartsPEntParDto) SetOrgCode(v string) *AlibabaAlihealthDrugtraceTopLsydQueryListpartsPEntParDto {
    s.OrgCode = &v
    return s
}
